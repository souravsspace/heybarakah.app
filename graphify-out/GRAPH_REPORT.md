...
## Corpus Check
- 412 files · ~171,323 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1401 nodes · 1691 edges · 53 communities detected
...
Cohesion: 0.04
Nodes (61): handleClose(), onPrimary(), onClose(), onNext(), listForMe(), listUnseen(), markSeen(), parseResponseJson() (+53 more)
...
Cohesion: 0.05
Nodes (25): captureError(), captureEvent(), main(), readDocs(), finish(), createMessageObjectSchema(), BlockedAppsContentView, BlockedAppsView (+17 more)

### Community 4 - "Community 4"
Cohesion: 0.05
Nodes (31): getInstalledApps(), getPermissionStatus(), presentFamilyActivityPicker(), relockApps(), removeBlockedItem(), requestPermissions(), setBlockConfiguration(), temporaryUnlock() (+23 more)
...
Cohesion: 0.05
Nodes (25): isSnapshot(), readEntitlementSnapshot(), ForceUpdateGate(), parseJson(), enqueueMutation(), load(), persist(), removeMutation() (+17 more)
...
Cohesion: 0.08
Nodes (24): enumerateDates(), isInSacredMonth(), addDays(), bool(), codesOfTier(), completeEval(), currentFajrStreak(), currentFullStreak() (+16 more)

### Community 13 - "Community 13"
Cohesion: 0.08
Nodes (21): buildAlAdhanQuery(), createAlAdhanCalendarUrl(), fetchAlAdhanCalendarByCoordinates(), fetchAlAdhanTimingsByCoordinates(), normalizeAlAdhanCalendarResponse(), normalizeAlAdhanDay(), parseAlAdhanDateToDateKey(), pickRequiredTimings() (+13 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (17): isTruthyFlag(), parseEnv(), buildSocialProviders(), buildTrustedOrigins(), createAuth(), randomOtp(), createLogger(), emit() (+9 more)
...
Cohesion: 0.12
Nodes (18): fmtRangeTime(), pad2(), fmt12(), addDays(), buildCounterWrite(), clearPrayer(), findLog(), getMyWeek() (+10 more)
...
Cohesion: 0.18
Nodes (14): buildRevenueCatSubscriptionDoc(), resolveProductId(), applyRevenueCatEntitlement(), asRecord(), booleanField(), buildReviewSubscriptionRow(), getMySubscription(), isExpired() (+6 more)
...
- **Thin community `Community 38`** (6 nodes): `welcome-card-stack.ts`, `clearWelcomeCardDrag()`, `completeWelcomeCardSwipe()`, `createWelcomeCardStackState()`, `startWelcomeCardDrag()`, `startWelcomeCardExit()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (4 nodes): `webhook.test.ts`, `mockValidate()`, `MockWebhookVerificationError`, `.constructor()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (4 nodes): `MainApplication`, `.onConfigurationChanged()`, `.onCreate()`, `MainApplication.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (4 nodes): `jsonContent()`, `jsonContentRequired()`, `json-content-required.ts`, `json-content.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (3 nodes): `progress.tsx`, `addDays()`, `mondayOf()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (3 nodes): `rating-prompt.tsx`, `rate()`, `requestStoreReview()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (3 nodes): `ExportWidgets0`, `index.swift`, `WidgetBundle`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (3 nodes): `use-widget-interactions.ts`, `useDhikrIncrement()`, `useWidgetInteractions()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 59`** (3 nodes): `widget-derive.test.ts`, `iso()`, `makeSnapshot()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (3 nodes): `hashDateKey()`, `pickDailyAyah()`, `daily-ayah.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 64`** (3 nodes): `BootReceiver`, `.onReceive()`, `BootReceiver.kt`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `parse()` connect `Community 6` to `Community 0`, `Community 2`, `Community 4`, `Community 7`, `Community 10`, `Community 20`, `Community 28`?**
  _High betweenness centrality (0.114) - this node is a cross-community bridge._
- **Why does `parseResponseJson()` connect `Community 0` to `Community 13`, `Community 6`?**
  _High betweenness centrality (0.056) - this node is a cross-community bridge._
- **Why does `pickImage()` connect `Community 0` to `Community 9`, `Community 13`, `Community 6`?**
