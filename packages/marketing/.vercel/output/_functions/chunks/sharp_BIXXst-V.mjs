import { A as AstroError, x as MissingSharp } from './entrypoint_5wAl8JpP.mjs';
import { b as baseService, p as parseQuality } from './generic_D9fd7K22.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_DmKHm04D.mjs').then(n => n.i)).default;
  } catch {
