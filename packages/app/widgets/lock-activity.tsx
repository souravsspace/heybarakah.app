...
function LockActivityLayout(
  ...
  return {
    // Lock-screen banner: a deep green-black surface (legible over any
    // wallpaper) with the mark on a mosque-green tile and a monospaced timer.
    banner: (
      <HStack
        modifiers={[
      ...
      >
        ...
        <VStack alignment="leading" spacing={3}>
          ...
          <Text
            modifiers={[
              font({ size: 19, weight: "semibold", design: "serif" }),
              foregroundStyle(CREAM),
            ]}
          >
            {prayer.title}
    ...
    compactLeading: mark(16),
    compactTrailing: timer(13, 44),
    minimal: mark(15),
    expandedLeading: (
      <HStack spacing={8}>
        {markTile(30, 18)}
    ...
    expandedTrailing: timer(17),
    expandedCenter: eyebrow,
  };
}
