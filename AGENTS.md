...
When designing or implementing any UI, components, layouts, or visual features, **always consult `DESIGN.md` first**. It contains the canonical design tokens, colors, typography, spacing, and component specifications for this project. All design work must align with the rules and tokens defined there.
