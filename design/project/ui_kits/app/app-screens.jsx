...
const HomeScreen = () => {
  ...
  const prayers = [
    ...
    {
      name: "Dhuhr",
      range: "Begins 12:14p · ends 3:42p",
      time: "12:14 PM",
      status: "late",
      state: "past",
    },
  ...
  return (
    <AppScaffold activeTab="home" tone="home">
      <div
        style={{
          flex: 1,
          overflow: "hidden",
      ...
      >
        ...
        >
          <div
            style={{ ...Sans, fontSize: 11, fontWeight: 600, color: C.text }}
          >
            {dateLine}
          </div>
          <div
        ...
        >
          <div style={{ position: "absolute", right: -7, bottom: -10 }}>
            <MosqueMinaret color={C.primary} opacity={0.16} size={132} />
          </div>
          <div
            style={{
              display: "flex",
        ...
        >
          ...
          >
            <span
              style={{ ...Sans, fontSize: 13, fontWeight: 700, color: C.text }}
            >
              Today
            </span>
            <span
          ...
          {prayers.map((p, i) => (
            <React.Fragment key={p.name}>
              ...
              {i < prayers.length - 1 && (
                <div
                  style={{ height: 1, background: C.divider, margin: "8px 0" }}
                />
              )}
            </React.Fragment>
          ))}
...
const PrayerRow = ({ name, range, time, status, state, progress }) => {
  ...
  if (status) {
    ...
    right = (
      <span style={{ ...Sans, fontSize: 12, fontWeight: 700, color }}>
        {label}
      </span>
    );
  } else {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div style={{ minWidth: 96, textAlign: "right", paddingTop: 6 }}>
          {right}
        </div>
      </div>
    </div>
...
const ProgressScreen = () => {
  ...
  return (
    <AppScaffold activeTab="progress" tone="progress">
      <div
        style={{
          flex: 1,
          overflow: "hidden",
      ...
      >
        ...
        >
          ...
          <div
            style={{ ...Serif, fontSize: 28, lineHeight: "34px", color: C.ink }}
          >
            Mā shāʾ Allāh.
          </div>
          <div style={{ ...Sans, fontSize: 13, color: C.text, marginTop: 2 }}>
            Apr 8 – 14
          </div>
        </div>
        ...
        >
          ...
          <SectionEyebrow style={{ marginTop: 6 }}>
            On-time prayers
          </SectionEyebrow>
        </div>
        ...
        >
          ...
          >
            <SectionEyebrow style={{ letterSpacing: "0.16em", fontSize: 10 }}>
              Daily on-time
            </SectionEyebrow>
            <span style={{ ...Sans, fontSize: 11, color: C.text }}>
              this week
            </span>
          </div>
        ...
        >
          <SectionEyebrow style={{ padding: "0 20px", fontSize: 10 }}>
            By prayer
          </SectionEyebrow>
...
const PrayerMatrix = ({ surface }) => {
  ...
  const color = (s, isToday) => {
    if (s === 1) {
      return { bg: C.primary, border: C.primary };
    }
    if (s === 2) {
      return { bg: "transparent", border: C.primary };
    }
    if (s === 3) {
      return { bg: C.border, border: C.border };
    }
    return {
      bg: isToday ? "rgba(41,96,62,0.08)" : "transparent",
      border: C.divider,
    };
  };
  return (
      ...
      {rows.map((r, ri) => (
        <div
          ...
          style={{
            ...
            gridTemplateColumns: "60px repeat(7, 1fr)",
            gap: 6,
            marginBottom: ri === rows.length - 1 ? 0 : 6,
            alignItems: "center",
          }}
        >
          <span
            style={{ ...Sans, fontSize: 11, fontWeight: 600, color: C.ink }}
          >
            {r.name}
          </span>
          {r.cells.map((s, ci) => {
                ...
                {s === 2 && (
                  <div
                    style={{
                      ...
                      borderRadius: 4,
                      background:
                        "repeating-linear-gradient(45deg, rgba(41,96,62,0.18) 0 2px, transparent 2px 4px)",
                    }}
                  />
                )}
              </div>
...
const DhikrScreen = () => {
  ...
  return (
    <AppScaffold activeTab="dhikr" tone="dhikr">
...
const LockedScreen = () => {
  ...
  return (
    <AppScaffold activeTab="locked" tone="locked">
      <div
        style={{
          flex: 1,
          overflow: "hidden",
      ...
      >
        ...
        <div style={{ padding: "8px 24px 0" }}>
          ...
          >
            <span style={{ ...Sans, fontSize: 13, color: C.text }}>
              Quiet at salah
            </span>
            <div style={{ textAlign: "right" }}>
              <div
                style={{ ...Sans, fontSize: 14, fontWeight: 600, color: C.ink }}
              >
                6:47 PM
              </div>
              <div
                style={{ ...Sans, fontSize: 12, color: C.text, marginTop: 2 }}
              >
                Next · Maghrib
              </div>
            </div>
        ...
        <div style={{ padding: "40px 24px 0" }}>
          ...
          <div style={{ ...Sans, fontSize: 13, color: C.text, marginTop: 4 }}>
              ...
              >
                <div
                  style={{
                    ...
                    padding: 4,
                    borderRadius: 14,
                    border: `1.5px solid ${a.selected ? C.primary : "transparent"}`,
                  }}
                >
                  <AppGlyph color={a.color} label={a.label} size={44} />
                  {a.selected && (
                    <div
                      style={{
                        position: "absolute",
                ...
                <span
                  style={{
                    ...Sans,
                    fontSize: 11,
                    fontWeight: a.selected ? 600 : 400,
                    color: a.selected ? C.ink : C.text,
                    marginTop: 8,
                  }}
                >
                  {a.name}
        ...
        <div style={{ padding: "36px 24px 0" }}>
          ...
          >
            <Icon color={C.text} name="search" size={16} />
            <span style={{ ...Sans, fontSize: 15, color: C.text }}>
              Search apps
            </span>
          </div>
          {allApps.map((a, i) => (
            <div
              ...
              style={{
                ...
                padding: "14px 0",
                borderBottom:
                  i < allApps.length - 1 ? `1px solid ${C.divider}` : 0,
              }}
            >
              <div
                style={{
              ...
              >
                {a.on && (
                  <Icon color="#fff" name="check" size={12} strokeWidth={2.4} />
                )}
              </div>
            </div>
          ))}
...
const ProfileScreen = () => {
  ...
  const Row = ({ icon, title, value, danger, last }) => (
    ...
    >
      <IconBox bg={danger ? "#FBEAE9" : C.neutralSoft}>
        <Icon color={danger ? "#B42318" : C.ink} name={icon} size={18} />
      </IconBox>
      <span
        style={{
          flex: 1,
          ...
          fontSize: 15,
          fontWeight: 600,
          color: danger ? "#B42318" : C.ink,
        }}
      >
        {title}
      </span>
      {value && (
        <span style={{ ...Sans, fontSize: 13, color: C.text, maxWidth: 140 }}>
          {value}
        </span>
      )}
      <Icon color={C.textLight} name="chevron" size={14} />
    </div>
  );
  ...
  const Section = ({ title, children }) => (
    <div style={{ marginTop: 28 }}>
      <SectionEyebrow
        style={{ padding: "0 20px", marginBottom: 10, letterSpacing: "0.20em" }}
      >
        {title}
      </SectionEyebrow>
  ...
  return (
    <AppScaffold activeTab="profile" tone="profile">
      <div
        style={{
          flex: 1,
          overflow: "hidden",
      ...
      >
        ...
        <div style={{ padding: "18px 20px 0" }}>
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              <div
                style={{ ...Serif, fontSize: 18, color: C.ink, marginTop: 2 }}
              >
                Layla Mohamed
              </div>
              <div
                style={{ ...Sans, fontSize: 12, color: C.text, marginTop: 1 }}
              >
                layla@heybarakah.app
              </div>
            </div>
            <Icon color={C.textLight} name="chevron" size={14} />
          </div>
        ...
        <Section title="Account">
          ...
          <Row icon="globe" last title="Calculation Method" value="ISNA" />
        </Section>

        <Section title="Permissions">
          <PermissionRow granted icon="pin" title="Location" />
          <PermissionRow granted icon="bell" last title="Notifications" />
        </Section>
        ...
        <Section title="Support & Legal">
          ...
          <Row icon="shield" last title="Privacy Policy" />
        </Section>

        <Section title="Account Actions">
          <Row icon="logout" title="Logout" />
          <Row danger icon="trash" last title="Delete Account" />
        </Section>
      </div>
    </AppScaffold>
  );
...
const PermissionRow = ({ icon, title, granted, last }) => (
  ...
  >
    <IconBox bg={C.neutralSoft}>
      <Icon color={C.ink} name={icon} size={18} />
    </IconBox>
    <span
      style={{ flex: 1, ...Sans, fontSize: 15, fontWeight: 600, color: C.ink }}
    >
      {title}
    </span>
    {granted ? (
